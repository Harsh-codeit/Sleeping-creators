...
def extract_audio_url(template_data: dict) -> Optional[str]:
...
def extract_preview_url(template_data: dict) -> Optional[str]:
...
def _apply_filter_and_audio(template_data: dict, filter_name: Optional[str], audio_url: Optional[str]) -> dict:

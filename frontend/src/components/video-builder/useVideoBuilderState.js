...
const ELEMENT_DEFAULTS = {
  text_overlay: {
    ...
    props: { text: "Text Overlay", font: "bold_sans", size_px: 28, line_height: 1.3, letter_spacing: 0,
             color: "#ffffff", bg_color: "#000000", bg_opacity: 0.5, bg_shape: "pill", align: "center", shadow: false,
             width_ratio: 0.65 },
  },
  lower_third: {
    ...
    overridable: false, override_key: null,
    props: { text: "Lower Third", font: "bold_sans", size_px: 24, line_height: 1.3, letter_spacing: 0,
             color: "#ffffff", bg_color: "#000000", bg_opacity: 0.7, bg_shape: "box", align: "left", shadow: false,
             width_ratio: 0.8 },
  },
  countdown: {
    ...
    start_at: 0, duration: null, animation_in: "fade", animation_out: "none",
    overridable: false, override_key: null,
    props: { end_at: 10.0, color: "#ffffff", font: "bold_sans", size_px: 56 },
  },
  cta_button: {
    ...
    props: { text: "Shop Now", font: "bold_sans", size_px: 18, bg_color: "#ffffff", text_color: "#000000",
             border_radius: 999, arrow: true, gradient: false,
             gradient_from: "#ffffff", gradient_to: "#cccccc", width_ratio: 0.35 },
  },
  cta_text: {
    type: "cta_text", x_ratio: 0.5, y_ratio: 0.78, z_index: 1,
    start_at: 0, duration: null, animation_in: "fade", animation_out: "none",
    overridable: true, override_key: "cta_text",
    props: { text: "Follow us", font: "bold_sans", size_px: 22, line_height: 1.3, letter_spacing: 0,
             color: "#ffffff", bg_color: "#000000", bg_opacity: 0.5, bg_shape: "none", align: "center", shadow: false,
             width_ratio: 0.65 },
  },
  link_in_bio: {
    ...
    start_at: 0, duration: null, animation_in: "fade", animation_out: "none",
    overridable: false, override_key: null,
    props: { text: "Link in bio", handle: "@brand", bg_color: "#000000", text_color: "#ffffff", width_ratio: 0.4 },
  },
  logo: {
